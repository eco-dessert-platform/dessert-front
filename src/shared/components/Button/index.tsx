...
const VARIANT_CLASS = {
  ...
  'primary-orange':
    'w-full py-[14px] text-center rounded-full bg-primary-orange-red border text-white border-solid border-gray-200',
  'primary-bd':
    'w-full py-[14px] text-center rounded-full bg-white border text-primary-orange-red border-solid border-primary-orange-red',

...
const ToastPop = ({ children, index = 0, action }: Props) => {
  ...
  return (
    <motion.div
      ...
      className="absolute w-full bottom-12 shadow-[0px_0px_10px_0px_rgba(0,0,0,0.3)] flex items-center justify-between px-[16px] py-[10px] bg-gray-800 rounded-[8px] text-white typo-title-14-medium"
    >
      <span>{children}</span>
